Pod::Spec.new do |s| 
  ...
  s.source  = { :git => 'https://github.com/netease-im/NIM_iOS_UIKit.git', :tag => '3.6.0'}
  s.platform = :ios, '9.0'
  ...
  s.subspec 'Full' do |cs|
    ...
    cs.dependency 'NIMSDK', '~> 8.6.0'
  end

  s.subspec 'Lite' do |cs|
    cs.source_files  = 'NIMKit/NIMKit/Classes/**/*.{h,m}'
    cs.dependency 'NIMKit/Core'
    cs.dependency 'NIMSDK_LITE', '~> 8.6.0'
  end
  
  s.subspec 'Core' do |os|     
    os.resources = 'NIMKit/Resources/*.*'   
    os.dependency 'SDWebImage', '~> 5.12.0'
